...
const XMAS_RANDOM_EFFECTS = ['angel-halo'];
const XMAS_RANDOM_DELAYS = [];
const XMAS_BLACKLIST = [];

export {KEYCODES, DATE_FORMATS, isKeyCode, getKeyCode, GENERIFY_OPTIONS, CUSTOM_AUTOCOMPLETE_ORDER, HALLOWEEN_RANDOM_EFFECTS, HALLOWEEN_RANDOM_DELAYS, HALLOWEEN_BLACKLIST, XMAS_RANDOM_EFFECTS, XMAS_RANDOM_DELAYS, XMAS_BLACKLIST};
